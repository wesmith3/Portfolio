    ...
    <div className="proj-list">
      <div className="card-container">
        ...
        <Card sx={{ maxWidth: 450, marginRight: 2 }} className="proj">
          <CardMedia component="div" sx={{ height: 300 }} title="Vignette">
            <Typography
              gutterBottom
              variant="h5"
              component="div"
        ...
        <Card sx={{ maxWidth: 400, marginRight: 2 }} className="proj">
          ...
          <CardContent>
            <Typography variant="body2" color="white">
              Step into the virtual aisles of our Blockbuster-inspired website,
              where you can register, peruse an extensive movie
              selection,rent/return your favorites, share your thoughts through
              reviews.
            </Typography>
          </CardContent>
          <CardActions>
        ...
        <Card sx={{ maxWidth: 400 }} className="proj">
          <CardMedia component="div" sx={{ height: 300 }} title="Audio Abyss">
            <Typography
              gutterBottom
              variant="h5"
              component="div"
          ...
          <CardContent>
            <Typography variant="body2" color="white">
              Discover new favorites through randomized song selections, where
              you can listen, add to your playlist, and rate with a simple like
              or dislike—an essential tool for music lovers craving fresh beats.
            </Typography>
          </CardContent>
          <CardActions>
            <Link
